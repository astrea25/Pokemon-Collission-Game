...
/**
 * This is the class for the fire used in the Dragon Breath Attack. This is responsible for drawing the fire that
 * faces the right side through the use of multiple Triangle objects..
 *
...
public class Fire implements DrawingObject{
     ...
     */
    public Fire(double x, double y, double size){
        this.x=x;
        this.y=y;
        this.size=size;
        initx = x;
    ...
    public void draw(Graphics2D g2d){
        ...
        g2d.rotate(Math.toRadians(90),x+size*0.1,y+size*1.5);
