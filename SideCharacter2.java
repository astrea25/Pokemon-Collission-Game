...
/**
 * This is the class for the Character drawing facing left. This is done through 
 * the use of multiple Square and Triangle classes.
 *
...
public class SideCharacter2 implements DrawingObject{
     ...
     */
    public SideCharacter2(double x, double y, double size){
        this.x=x;
        this.y=y;
        this.size=size;
        initx = x;
    ...
    public void draw(Graphics2D g2d){
        ...
        tailConnection = new Square(x-size*0.448+size*0.484,y+size*1.63,size*0.17,size*0.1, Color.decode("#ff7d3e"));
        tailConnection.draw(g2d);
        
        tailBody = new Square(x-size*0.45+size*0.555,y+size*1.32,size*0.1,size*0.34, Color.decode("#ff7d3e"));
        tailBody.draw(g2d);
        ...
        eyeBlack = new Square(x-size*0.1*0.6-size*0.225,y+size*1.32,size*0.1,size*0.17, Color.BLACK);
        eyeBlack.draw(g2d);

        eyeBlack = new Square(x-size*0.1*0.1-size*0.275,y+size*1.32,size*0.05,size*0.05, Color.WHITE);
        eyeBlack.draw(g2d);
