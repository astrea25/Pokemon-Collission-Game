...
/**
 * This is the class for the Triangle. This is responsible for creating and drawing the basic shape, Triangle.
 *
...
public class Triangle implements DrawingObject{
    ...
    public void draw(Graphics2D g2d){
        ...
        mid.moveTo(x+size*.05,y+size*1.05);   
        mid.lineTo(x+size*.95, y+size*1.05);
        mid.lineTo(x+size*.5, y+size*0.05-size*0.3);
        mid.closePath();  
        g2d.setPaint(color);
        g2d.fill(mid);
        g2d.draw(mid);
